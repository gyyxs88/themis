...
### 2.2 Themis 是入口形态之一，不是数字员工唯一物理形态
...
- `Platform / Control Plane`
  统一维护组织、主体、工作队列、状态、治理、审计和调度。
- `主 Themis`
  公司级硅基合伙人，对接飞书机器人和 Web 管理面。
- `Personal Themis`
...
### 6.5 调度时序图（公司主 Themis 派工 -> waiting -> 恢复）
...
### Phase 3：把主 Themis 改造成 Gateway

目标：

- 主 Themis 继续承接飞书/Web
- 但数字员工状态、调度和治理事实改由平台提供
