...
test("extractFeishuMessageResources 会按同一条 post 的原始交错顺序提取多张图片", () => {
  const resources = extractFeishuMessageResources({
    message: {
      message_type: "post",
      message_id: "msg-post-3",
  ...
  assert.deepEqual(resources, [{
    id: "msg-post-3::img-key-post-3",
    type: "image",
    resourceKey: "img-key-post-3",
    sourceMessageId: "msg-post-3",
    createdAt: new Date(1775040596999).toISOString(),
  }, {
    id: "msg-post-3::img-key-post-4",
    type: "image",
    resourceKey: "img-key-post-4",
    sourceMessageId: "msg-post-3",
    createdAt: new Date(1775040596999).toISOString(),
  }]);
});
